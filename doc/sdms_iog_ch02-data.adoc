...
Other solutions may be added, but this is an easy win and addresses requirements both within numerical simulation communities, satellite CalVal communities and WMO programmes.
