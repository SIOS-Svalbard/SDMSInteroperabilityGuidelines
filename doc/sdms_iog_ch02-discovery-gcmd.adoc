...
The Global Change Master Directory (GCMD) Directory Interchange Format (DIF) <<#anchor-13,[15]>> is a metadata standard that is widely used (e.g. by the Antarctic Master Directory) and that was
